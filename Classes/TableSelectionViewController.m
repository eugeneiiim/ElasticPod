...
/*    
	...
	if ([cell.text compare:self.textThingToSet.text] == NSOrderedSame) {
		[cell setSelected];
	}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	[self.stringToSet setString:[options objectAtIndex:indexPath.row]];
	self.textThingToSet.text = [options objectAtIndex:indexPath.row];
